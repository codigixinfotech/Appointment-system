...
export const HospitalForm = () => {
  ...
  return <div className="min-h-screen bg-gray-50 text-gray-800 p-8">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => navigate('/admin')} className="flex items-center gap-2 text-gray-500 hover:text-gray-800 font-medium mb-6 transition-colors cursor-pointer">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="bg-white rounded p-4 border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="e.g. City General Hospital" value={formData.name} onChange={e => setFormData({
                ...formData,
                name: e.target.value,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="e.g. CityGeneral" value={formData.brandName} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center border border-gray-200 rounded overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                  ...
                  <input required type="text" placeholder="city-general" value={formData.slug} onChange={e => setFormData({
                  ...formData,
                  slug: e.target.value
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="url" placeholder="https://..." value={formData.logoUrl} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="e.g. 123 Health Ave, NY" value={formData.address || ''} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input type="text" placeholder="e.g. ChIJN1t_tDeuEmsRUsoyG83frY4" value={formData.googlePlaceId || ''} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="+1 (555) 123-4567" value={formData.phone || ''} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="911 or +1 800-EMG" value={formData.emergencyPhone || ''} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2">
                ...
                <input required type="text" placeholder="hospital@upi" value={formData.upiId || ''} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex flex-col gap-2 col-span-1 md:col-span-2">
                ...
                <input required type="text" placeholder='<iframe src="https://www.google.com/maps/embed?pb=..." ></iframe>' value={formData.mapEmbedUrl || ''} onChange={e => {
          ...
          <div className="bg-white rounded p-4 border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              ...
              <button type="button" onClick={() => setWorkingHours([...workingHours, {
              label: '',
              time: '',
              isEmergency: false
            ...
            <div className="flex flex-col gap-3">
              {workingHours.map((wh, index) => <div key={index} className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg border border-gray-100">
                  <input type="text" placeholder="e.g. Mon - Fri" value={wh.label} onChange={e => {
                ...
                setWorkingHours(newWh);
                  ...
                  <input type="text" placeholder="e.g. 9:00 AM - 5:00 PM" value={wh.time} onChange={e => {
                const newWh = [...workingHours];
                ...
                setWorkingHours(newWh);
                  ...
                  <label className="flex flex-1 items-center gap-2 text-xs text-gray-600 cursor-pointer whitespace-nowrap">
                    <input type="checkbox" checked={wh.isEmergency || false} onChange={e => {
                  const newWh = [...workingHours];
              ...
              {workingHours.length === 0 && <p className="text-sm text-gray-500 text-center py-4">No working hours defined.</p>}
            </div>
          </div>
          ...
          <div className="bg-white rounded p-4 border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  <input type="color" value={theme.primaryColor} onChange={e => setTheme({
                  ...theme,
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  <input type="color" value={theme.secondaryColor} onChange={e => setTheme({
                  ...theme,
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  <input type="color" value={theme.backgroundColor} onChange={e => setTheme({
                  ...theme,
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-3">
                  <input type="color" value={theme.textColor} onChange={e => setTheme({
                  ...theme,
            ...
            {/* Theme Preview */}
            <div className="mt-8 p-2 rounded border border-gray-200" style={{
            backgroundColor: theme.backgroundColor
              ...
              <div className="flex gap-4">
                <button type="button" className="p-2 rounded text-xs shadow-sm cursor-pointer" style={{
                backgroundColor: theme.primaryColor,
                color: '#fff'
              }}>
                  Solid Button
                </button>
                <button type="button" className="p-2 rounded text-xs bg-transparent border-2 cursor-pointer" style={{
          ...
          <div className="flex justify-end pt-4">
            <button type="submit" className="bg-indigo-600 hover:bg-indigo-700 text-white p-2 rounded text-sm flex items-center gap-2 shadow-lg transition-all text-lg cursor-pointer">
