      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">{id ? 'Edit Hospital Details' : 'Hospital Details'}</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">Hospital Full Name</label>
                <input
                  required
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">Brand Name (Short)</label>
                <input
                  required
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">URL Slug (Subdomain / Path)</label>
                <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                  <span className="bg-gray-50 px-4 py-3 text-gray-500 text-sm font-medium border-r border-gray-200">
                    /hospitals/
                  </span>
                  <input
                    required
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">Google Place ID (Optional)</label>
                <input
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">Emergency Phone</label>
                <input
                  required
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-sm font-bold text-gray-700">Payment UPI ID (QR Code)</label>
                <input
                  required
                  type="text"
              ...
              <div className="flex flex-col gap-2 col-span-1 md:col-span-2">
                <label className="text-sm font-bold text-gray-700">Google Maps Embed URL (iframe src)</label>
                <input
                  required
                  type="url"
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-gray-500 uppercase">Primary / Button Solid</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-bold text-gray-500 uppercase">Secondary / Button Outline</label>
                <div className="flex items-center gap-3">
                  <input
                    type="color"
            ...
            {/* Theme Preview */}
            <div className="mt-8 p-6 rounded-xl border border-gray-200" style={{ backgroundColor: theme.backgroundColor }}>
              <h4 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: theme.textColor }}>Live Preview</h4>
              <div className="flex gap-4">
                <button
                  type="button"
                  className="px-6 py-2.5 rounded-lg font-bold shadow-sm"
                ...
                <button
                  type="button"
                  className="px-6 py-2.5 rounded-lg font-bold bg-transparent border-2"
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 shadow-lg transition-all text-lg"
            >
